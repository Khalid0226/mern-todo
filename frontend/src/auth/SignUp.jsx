...
function SignUp() {
    ...
    const postData = async (e) =>{
        ...
        try {
            const response = await axios.post('http://localhost:2100/signup',{
                name:name,
                email:email,
                password:password
            })
            ...
            <div className="bg-white p-8 rounded-lg shadow-md w-96">
                ...
                <div className="space-y-4">
                    <form onSubmit={postData}>
                        ...
                        <button type='submit' className="mt-5 w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-600 transition">submit</button>
